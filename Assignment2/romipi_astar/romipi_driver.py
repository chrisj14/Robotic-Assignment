...
class AStar:
    ...
    def print_debug_info(self):
        ...
        print(( "Commanded Twist (linear m/s, rotation rad/s: %0.1f, %0.1f" % self.read_tw$
        print( "Estimates:")
        print(( "Estimated Twist (linear m/s, rotation rad/s): %0.2f, %0.2f" % self.read_p$
        print(( "Estimated Pose (x m,y m, theta rad): %0.1f, %0.1f %0.1f" % self.read_pose$
